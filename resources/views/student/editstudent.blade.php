                        ...
                        <div class="py-2 h-screen bg-gray-300 px-2">
                            <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
                                <div class="md:flex">
                                    ...
                                    <form class="w-full px-4 py-6 " action="/storestudent/{{$student->id}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    <div class="w-full px-4 py-6 ">
                                        <div class="mb-1"> <span class="text-sm">Full name</span> <input value="{{ $student->name }}" type="text" name="name" class="h-12 px-3 w-full border-blue-400 border-2 rounded focus:outline-none focus:border-blue-600"> </div>
                                        @error('name')
                                        ...
                                        <div class="mb-1"> <span>Choose Profile Image</span>
                                            ...
                                            <img alt="Profile Image" src="{{ asset('images') }}/{{ $student->profileimage }}" id="previewImg" style="max-width: 150px;" class="mt-2" /></div>
                                        </div>
                                        
                                        <div class="mt-3 text-right"> <button type="submit" class="ml-2 h-10 w-32 bg-blue-600 rounded text-white hover:bg-blue-700">Update</button> </div>
                                    </div>
                                </form>
                                </div>
                            </div>
